...
- **Phase 2 Solution Submission**: Thursday, 3rd September 2026, 9:00 PM
...
### Phase 2: Solution
- **Deadline**: 3rd September 2026, 9:00 PM
- **Format**: Complete MVP, code repository (Github), deployment packages (if any), and a demonstration video (in English).
